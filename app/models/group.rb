...
require 'faraday'
  ...
  def self.sync_groups
    response_json = Faraday.get 'https://broadcast.threema.ch/api/v1/identities/aIZQ2wdtA8/groups' do |req|
  ...
  def get_image
    response_json = Faraday.get "https://broadcast.threema.ch/api/v1/identities/aIZQ2wdtA8/groups/#{self.threema_id}/image" do |req|
      req.params['limit'] = 100
      req.headers['Content-Type'] = 'application/json'
      req.headers['X-API-Key'] = 'KH4RJ66FT39SLA7EED56A8Y4M92R82PM'
    end
  ...
  def get_members_from_server
    json_members = Faraday.get "https://broadcast.threema.ch/api/v1/identities/aIZQ2wdtA8/groups/#{self.threema_id}/members?pageSize=0" do |req|
      req.params['limit'] = 100
      req.headers['Content-Type'] = 'application/json'
      req.headers['X-API-Key'] = 'KH4RJ66FT39SLA7EED56A8Y4M92R82PM'
  ...
  def delete_from_threema
    json_members = Faraday.delete "https://broadcast.threema.ch/api/v1/identities/aIZQ2wdtA8/groups/#{self.threema_id}" do |req|
      req.params['limit'] = 100
      req.headers['Content-Type'] = 'application/json'
      req.headers['X-API-Key'] = 'KH4RJ66FT39SLA7EED56A8Y4M92R82PM'
    end
  ...
  def update_group_attributes
    ...
    json_members = Faraday.put "https://broadcast.threema.ch/api/v1/identities/aIZQ2wdtA8/groups/#{self.threema_id}" do |req|
      req.params['limit'] = 100
      req.headers['Content-Type'] = 'application/json'
      req.headers['X-API-Key'] = 'KH4RJ66FT39SLA7EED56A8Y4M92R82PM'
